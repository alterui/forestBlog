...
(function ($) {
    ...
    function write() {
        var content = "<div class=\"ds-dialog\" id='PAY_" + id + "'>"
            ...
            + "       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src='/img/shang/weixinpay1.jpg'  />"
            + "      </div>"
            + "      <p class=\"qrcode-tip\">打赏</p>"
            + "     </div>"
            + "     <div class=\"qrcode-img qrCode_1\" id=\"qrCode_1\">"
            + "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(102,153,204)\">"
            + "       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\"  src=\"/img/shang/qqpay1.jpg\"  />"
            + "      </div>"
            + "      <p class=\"qrcode-tip\">打赏</p>"
            + "     </div>"
            + "     <div class=\"qrcode-img qrCode_2\" id=\"qrCode_2\">"
            + "      <div class=\"qrcode-border box-size\" style=\"border: 9.02px solid rgb(14,26,235)\">"
            + "       <img  class=\"qrcode-img qrCode_2\" id=\"qrCode_2\"  src=\"/img/shang/alipay1.jpg\"  />"
            + "      </div>"
            + "      <p class=\"qrcode-tip\">打赏</p>"
            + "     </div>"
            + "     </div>"
